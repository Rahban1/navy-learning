...
export function Radar2() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-black w-full max-h-full relative bg-center bg-[url(/images/radar3.png)] font-rock2 bg-100 bg-no-repeat">     
        <AnimatedButton icon={<BackIcon/>} onclick={()=>{navigate('/map')}}/>
        
        <div className="absolute left-[23%] top-1/2 z-2">
        ...
        <div className="absolute right-[22%] top-[32%] z-2">
          <Button3D onclick={()=>{navigate('/map-c-ranges')}}>Clearing Ranges <br /> (NLT and NMT) </Button3D>
        </div>
        
        <div className="absolute right-[22%] top-[56%] z-2">
