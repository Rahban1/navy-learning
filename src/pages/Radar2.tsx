...
export function Radar2() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-black w-full max-h-full relative bg-center bg-[url(/images/radar-final.jpeg)] font-rock2 bg-100 bg-no-repeat">     
        ...
        <div className="absolute left-[24%] top-[42%] z-2">
            <Arrow color="text-white" rotation={-27}/>
        </div>
        ...
        <div className="absolute right-[20%] top-[27%] z-2">
            <Arrow color="text-white" rotation={188} />
        </div>
        <div className="absolute right-[19%] top-[30%] z-2">
            <Arrow color="text-white" rotation={157} />
        </div>
        ...
        <div className="absolute right-[23%] top-[59%] z-2">
            <Arrow color="text-white" rotation={167} />
        </div>
