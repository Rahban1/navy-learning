...
export function Bridge() {
  ...
  return (
    <div className='overflow-hidden relative w-full h-screen'>
      ...
      <div 
          className=' w-36 h-20 z-20 cursor-pointer absolute left-[39vw] top-[19vw]'
  ...
  {hoveredItem && (
    <motion.div
      className="z-10 absolute cursor-pointer left-[34%] top-[22%] w-[17%] h-[30%] bg-black shadow-lg p-4 rounded-lg overflow-hidden"
